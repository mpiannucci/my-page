...
def apps():
    ...
    loop = ForLoop()
    self = TemplateResult(); extend_ = self.extend
    extend_([u'<div id="projectContainer" class="container">\n'])
...
def base (page):
    ...
    extend_([u'        <div id="mainContent" class="container">\n'])
    ...
    extend_([u'        <div id="footer" class="container">\n'])
    extend_([u'            <div class="row">\n'])
...
def bio():
    ...
    loop = ForLoop()
    self = TemplateResult(); extend_ = self.extend
    extend_([u'<div id="contactContainer" class="container">\n'])
    extend_([u'        <h1 id="contactTitle">Bio</h1>\n'])
    extend_([u'        <hr>\n'])
    extend_([u'        <div id="contactBody" class="container">\n'])
    extend_([u'                <div class="row">\n'])
...
def blog (pageNum):
    ...
    extend_([u'\n'])
    extend_([u'<div id="blogContainer" class="container">\n'])
...
def index():
    ...
    loop = ForLoop()
    self = TemplateResult(); extend_ = self.extend
    extend_([u'<div id="homeContainer" class="container"> \n'])
    extend_([u'    <div class="row">\n'])
    extend_([u'        <div class="col-lg-12 text-center">\n'])
...
def view (post):
    ...
    self = TemplateResult(); extend_ = self.extend
    extend_([u'\n'])
    extend_([u'<div id="viewContainer" class="container">\n'])
    extend_([u'    <div class="row">\n'])
    extend_([u'        <div class="col-lg-12">\n'])
