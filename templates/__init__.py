...
def apps():
    ...
    extend_([u'        <a href="/hackwinds" class="btn btn-primary">Get it!</a>\n'])
    extend_([u'    </div>\n'])
    extend_([u'</div>\n'])
...
def hackwinds():
    ...
    extend_([u'<div class="row">\n'])
    extend_([u'<div class="col-lg-12 jumbotron hackwinds-jumbotron">\n'])
    ...
    extend_([u'    <div class="col-lg-12 text-center">\n'])
    extend_([u'        <div class="container">\n'])
    extend_([u'        <h1 id="featuresHeader">Features</h1>\n'])
    extend_([u'        </div>\n'])
    extend_([u'    </div>\n'])
    extend_([u'</div> -->\n'])
    extend_([u'<!-- /.row -->\n'])
    ...
    extend_([u'        <a href="https://github.com/mpiannucci/HackWinds-iOS" class="btn btn-info">View the iOS Source</a>\n'])
    extend_([u'        <a href="https://github.com/mpiannucci/HackWinds" class="btn btn-info">View the Android Source</a>\n'])
    extend_([u'        </div>\n'])
    extend_([u'    </div>\n'])
    extend_([u'</div>\n'])
    extend_([u'<!-- /.row -->\n'])
