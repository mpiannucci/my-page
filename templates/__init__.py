...
def apps():
    ...
    extend_([u'            <img class="img-responsive apps-page-screenshot" src="/static/Images/hackwinds-ios-live.png" />\n'])
    extend_([u'        </div>\n'])
...
def hackwinds():
    ...
    extend_([u'            <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'                <div class="thumbnail">\n'])
    extend_([u'                    <img class="hackwinds_landing_screenshots" src="/static/Images/hackwinds-ios-live.png" alt="Live Screenshot">\n'])
    extend_([u'                    <div class="caption">\n'])
    extend_([u'                        <h3>Live Streaming Camera</h3>\n'])
    extend_([u'                        <p>View the HD stream straight from Narragansett Beach wherever you are.</p>\n'])
    extend_([u'                    </div>\n'])
    extend_([u'                </div>\n'])
    extend_([u'            </div>\n'])
    extend_([u'            <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'                <div class="thumbnail">\n'])
    extend_([u'                    <img class="hackwinds_landing_screenshots" src="/static/Images/hackwinds-ios-forecast.png" alt="Forecast Screenshot">\n'])
    extend_([u'                    <div class="caption">\n'])
    extend_([u'                        <h3>5 Day Forecast</h3>\n'])
    extend_([u'                        <p>Get the latest forecast information for the upcoming 5 days.</p>\n'])
    extend_([u'                    </div>\n'])
    extend_([u'                </div>\n'])
    extend_([u'            </div>\n'])
    extend_([u'            <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'                <div class="thumbnail">\n'])
    extend_([u'                    <img class="hackwinds_landing_screenshots" src="/static/Images/hackwinds-ios-buoy.png" alt="Buoy Screenshot">\n'])
    extend_([u'                    <div class="caption">\n'])
    extend_([u'                        <h3>Live Buoy Data</h3>\n'])
    extend_([u'                        <p>Get the latest NOAA buoy reports, showing the current swell in the water.</p>\n'])
    extend_([u'                    </div>\n'])
    extend_([u'                </div>\n'])
    extend_([u'            </div>\n'])
    extend_([u'            <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'                <div class="thumbnail">\n'])
    extend_([u'                    <img class="hackwinds_landing_screenshots" src="/static/Images/hackwinds-ios-tide.png" alt="Tide Screenshot">\n'])
    extend_([u'                    <div class="caption">\n'])
    ...
    extend_([u'            <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'                <div class="thumbnail">\n'])
    extend_([u'                    <img class="hackwinds_landing_screenshots" src="/static/Images/hackwinds-android-live.png" alt="Live Screenshot">\n'])
    extend_([u'                    <div class="caption">\n'])
    extend_([u'                        <h3>Live Streaming Camera</h3>\n'])
    extend_([u'                        <p>View the HD stream straight from Narragansett Beach wherever you are.</p>\n'])
    extend_([u'                    </div>\n'])
    ...
    extend_([u'            <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'                <div class="thumbnail">\n'])
    extend_([u'                    <img class="hackwinds_landing_screenshots" src="/static/Images/hackwinds-android-forecast.png" alt="Forecast Screenshot">\n'])
    extend_([u'                    <div class="caption">\n'])
    extend_([u'                        <h3>5 Day Forecast</h3>\n'])
    extend_([u'                        <p>Get the latest forecast information for the upcoming 5 days.</p>\n'])
    extend_([u'                    </div>\n'])
    ...
    extend_([u'            <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'                <div class="thumbnail">\n'])
    extend_([u'                    <img class="hackwinds_landing_screenshots" src="/static/Images/hackwinds-android-buoy.png" alt="Buoy Screenshot">\n'])
    extend_([u'                    <div class="caption">\n'])
    extend_([u'                        <h3>Live Buoy Data</h3>\n'])
    extend_([u'                        <p>Get the latest NOAA buoy reports, showing the current swell in the water.</p>\n'])
    extend_([u'                    </div>\n'])
    ...
    extend_([u'            <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'                <div class="thumbnail">\n'])
    extend_([u'                    <img class="hackwinds_landing_screenshots" src="/static/Images/hackwinds-android-tide.png" alt="Tide Screenshot">\n'])
    extend_([u'                    <div class="caption">\n'])
    extend_([u'                        <h3>Tide Information</h3>\n'])
    extend_([u'                        <p>View the upcoming tides, as well as the sunrise and sunset for the day so you can plan whether to dawn patrol or leave work early.</p>\n'])
    extend_([u'                    </div>\n'])
    ...
    extend_([u'            <a href="https://github.com/mpiannucci/HackWinds" class="btn btn-info hackwinds-github-button">View the Android Source</a>\n'])
    extend_([u'        </div>\n'])
    extend_([u'    </div>\n'])
    extend_([u'</div>\n'])
    extend_([u'<!-- /.row -->\n'])
