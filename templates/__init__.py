...
def view (post):
    ...
    extend_([u'        <h3>', escape_(datestr(post.posted_on), True), u'</h3>\n'])
    ...
    extend_([u'                        <tr>\n'])
    extend_([u'                                <td><a href="/view/', escape_(post.id, True), u'">Link</a></td>\n'])
...
def admin (user, posts):
    ...
    for post in loop.setup(posts):
        extend_(['                ', u'<li>\n'])
        extend_(['                ', u'        <a href="/view/', escape_(post.id, True), u'">', escape_(post.title, True), u'</a> \n'])
        extend_(['                ', u'        from ', escape_(datestr(post.posted_on), True), u' \n'])
        extend_(['                ', u'        <a href="/edit/', escape_(post.id, True), u'">Edit</a>\n'])
        extend_(['                ', u'        <form action="/delete/', escape_(post.id, True), u'" method="post">\n'])
...
def blog (pageNum):
    ...
    for post in loop.setup(posts):
        postCount+=1
        extend_(['    ', u'<h2 class="links"><a href="/view/', escape_(post.id, True), u'">', escape_(post.title, True), u'</a></h2>\n'])
        extend_(['    ', u'<h3>', escape_(datestr(post.posted_on), True), u'</h3>\n'])
        ...
        extend_(['    ', u'  <table class="linkTable">\n'])
        extend_(['    ', u'    <tr>\n'])
        extend_(['    ', u'      <td><a href="/view/', escape_(post.id, True), u'">Comment</a></td>\n'])
        extend_(['    ', u'      <td>Tagged &nbsp; <a href="/tag/', escape_(post.tag, True), u'">', escape_(post.tag, True), u'</a></td>\n'])
        extend_(['    ', u'    </tr>\n'])
        extend_(['    ', u'  </table>\n'])
        extend_(['    ', u'</div>\n'])
...
def archive (posts):
    ...
    for post in loop.setup(posts):
        extend_(['            ', u'<tr>\n'])
        extend_(['            ', u'    <td>\n'])
        extend_(['            ', u'        <h3 class="links"><a href="/view/', escape_(post.id, True), u'">', escape_(post.title, True), u'</a></h3> \n'])
        extend_(['            ', u'    </td>\n'])
        extend_(['            ', u'    <td>\n'])
        extend_(['            ', u'        <h3 id="archiveTime">&nbsp; ', escape_(datestr(post.posted_on), True), u'</h3>\n'])
        extend_(['            ', u'    </td>\n'])
        extend_(['            ', u'</tr>\n'])
    extend_([u'        </table>\n'])
    extend_([u'    </div>\n'])
