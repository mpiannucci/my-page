...
def apps():
    ...
    extend_([u'        <div id="HackWindsCols" class="col-sm-12 jumbotron hackwinds-jumbotron">\n'])
    ...
    extend_([u'        </div>\n'])
    extend_([u'        <div id="MapgetterCols" class="col-sm-12 jumbotron mapgetter-jumbotron">\n'])
    ...
    extend_([u'        </div>\n'])
    extend_([u'        <div id="OtherCols" class="col-sm-12 jumbotron">\n'])
