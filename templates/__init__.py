...
def hackwinds():
    ...
    extend_([u'            <img class="hackwinds_landing_screenshots" src="/static/Images/Hackwinds-ios1.png" alt="Live Screenshot">\n'])
    ...
    extend_([u'    <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'        <div class="thumbnail">\n'])
    extend_([u'            <img class="hackwinds_landing_screenshots" src="/static/Images/Hackwinds-ios2.png" alt="Forecast Screenshot">\n'])
    extend_([u'            <div class="caption">\n'])
    ...
    extend_([u'    <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'        <div class="thumbnail">\n'])
    extend_([u'            <img class="hackwinds_landing_screenshots" src="/static/Images/Hackwinds-ios3.png" alt="Buoy Screenshot">\n'])
    extend_([u'            <div class="caption">\n'])
    ...
    extend_([u'    <div class="col-md-3 col-sm-6 hero-feature">\n'])
    extend_([u'        <div class="thumbnail">\n'])
    extend_([u'            <img class="hackwinds_landing_screenshots" src="/static/Images/Hackwinds-ios4.png" alt="Tide Screenshot">\n'])
    extend_([u'            <div class="caption">\n'])
...
def index():
    ...
    extend_([u'\n'])
    extend_([u"            <p>I am an Engineer from Rhode Island with a Bachelor's of Science in Ocean Engineering from the University of Rhode Island. Growing up in Rhode Island, I was drawn to the ocean. While my heart still lives with the sea, my interests shifted in college, driving me towards software and electronics development. I have forged my own path to create a unique skillset with the best of software and traditional engineering.</p>\n"])
    extend_([u'\n'])
    ...
    extend_([u'\n'])
    extend_([u"            <p>My favorite hobbies include surfing and skiing. There's nothing like 35 degree water to wake up the brain!</p>\n"])
    extend_([u'\n'])
