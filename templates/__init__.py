...
def admin (user, posts):
    ...
    extend_([u'    <div class="col-sm-6">\n'])
    extend_([u'        <div class="container">\n'])
    extend_([u'            <h3>Edit posts</h3>\n'])
    extend_([u'            <ul>\n'])
    for post in loop.setup(posts):
        extend_(['                ', u'<li class="postlist">\n'])
        extend_(['                ', u'    <p><a href="/view/', escape_(post.url, True), u'">', escape_(post.title, True), u'</a> from ', escape_(datestr(post.date), True), u'</p>\n'])
        extend_(['                ', u'    <ul class="list-inline">\n'])
        extend_(['                ', u'        <li><a class="btn btn-primary" href="/edit/', escape_(post.url, True), u'">Edit</a></li>\n'])
