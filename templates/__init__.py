...
def apps():
    ...
    extend_([u'            <img class="img-responsive apps-page-screenshot" src="/static/Images/Screenshots/hackwinds-ios-live.png" />\n'])
    extend_([u'        </div>\n'])
...
def hackwinds():
    ...
    extend_([u'                        <p>Get the latest forecast information for the upcoming 5 days. Custom color coding indicates the predicted surf quality for the region.</p>\n'])
    extend_([u'                    </div>\n'])
    extend_([u'                </div>\n'])
    extend_([u'            </div>\n'])
    extend_([u'            <div class="col-md-4 col-sm-6 hero-feature">\n'])
    ...
    extend_([u'                        <p>View animated swell, wind, and period forecast charts for each of the upcoming five days.</p>\n'])
    extend_([u'                    </div>\n'])
    extend_([u'                </div>\n'])
    extend_([u'            </div>\n'])
    ...
    extend_([u'                    <div class="caption">\n'])
    extend_([u'                        <h3>Live Buoy Data</h3>\n'])
    extend_([u'                        <p>Get the latest NOAA buoy reports, showing the current swell in the water. Convienently iew the current wave spectra breakdown from Block Island, Montauk, and Nantucket.</p>\n'])
    extend_([u'                    </div>\n'])
    extend_([u'                </div>\n'])
    extend_([u'            </div>\n'])
    extend_([u'            <div class="col-md-4 col-sm-6 hero-feature">\n'])
